	  ...
	  <head>
		  ...
		  <style>
			  body {
				  ...
				  font-family: TimesNewRomam, sans-serif;
				  text-align: center;
				  color: #333;
			  }
			  .container {
	  ...
	  <body>
		  ...
		  <div class="container">
			  <div class="border">
				  ...
				  <h2>This is to certify that  ${userData.Name} successfully completed the course _writing skills by Kevin Missal_  from Hubhawks MasterClass </h2>
			  </div>
	  <div class="row">
